...
import { adminLogin, adminLogout, adminRegister, getAllData, getAllUsers, myProfile, searchUsers, userBlock, userDelete, userDetails, userUnBlock } from '../controllers/admin.controller.js';
