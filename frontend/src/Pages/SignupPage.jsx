                ...
                <div className="flex flex-col">
                    ...
                    {username.length >= 3 && (
                        <div className="text-sm mt-1 ml-1">
                            ...
                            {!checkingUsername && isUsernameAvailable === true && <span className="text-green-600">✅ Username is available</span>}
                            {!checkingUsername && isUsernameAvailable === false && <span className="text-red-600">❌ Username is taken</span>}
                        </div>
                    )}
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    {email.length > 5 && (
                        <div className="text-sm mt-1 ml-1">
                            ...
                            {!checkingEmail && isEmailAvailable === true && <span className="text-green-600">✅ Email is available</span>}
                            {!checkingEmail && isEmailAvailable === false && <span className="text-red-600">❌ Email already in use</span>}
                        </div>
                    )}
                </div>
